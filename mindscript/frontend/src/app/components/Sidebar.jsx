  ...
  return (
    <aside
      className={`
        ...
        bg-[#050505] border-r border-white/5 text-white h-screen fixed top-0 left-0
      ...
      <nav className="flex-1 px-2 space-y-2">
        {menuItems.map((item, i) => (
          <Link
            key={i}
            href={item.href}
            className="flex items-center gap-3 px-2 py-2 rounded-md hover:bg-purple-600 transition mt-5"
          >
            {item.icon}
