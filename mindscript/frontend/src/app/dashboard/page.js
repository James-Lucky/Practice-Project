    ...
    <div className="flex flex-col h-screen bg-black text-white">
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        {messages.length === 0 ? (
          ...
          <div className="flex-1 flex items-center justify-center">
            <div className="text-center">
              <h1 className="text-5xl md:text-7xl font-bold mb-4 bg-gradient-to-r from-white via-purple-300 to-purple-600 bg-clip-text text-transparent">
            ...
            >
                ...
                <div key={index} className="max-w-4xl mx-auto">
                  {message.role === "user" ? (
                    <div className="flex justify-end mb-4">
                      <div className="bg-purple-600 text-white rounded-2xl px-4 py-3 max-w-xs md:max-w-2xl shadow-lg shadow-purple-900/20">
                        <p className="text-sm">{message.content}</p>
                      </div>
                    </div>
                  ) : (
                    <div className="flex justify-start mb-4">
                      <div className="bg-[#1a1a1a] border border-white/5 text-white rounded-2xl px-4 py-3 max-w-xs md:max-w-2xl">
              ...
              {isLoading && (
                <div className="max-w-4xl mx-auto">
                  <div className="flex justify-start mb-4">
                    <div className="bg-[#1a1a1a] border border-white/5 text-white rounded-2xl px-4 py-3">
        ...
        <div className=" px-4 py-4">
          <div className="max-w-4xl mx-auto">
            <div className="relative flex items-end bg-[#0a0a0a] rounded-full border border-white/10 focus-within:border-purple-500 focus-within:ring-1 focus-within:ring-purple-500/50 transition-all shadow-lg">
              {/* Textarea */}
              <textarea
                ref={taRef}
              ...
              <div className="relative">
                <button
                  ...
                  className="p-3 text-gray-400 hover:text-purple-400 transition-colors rounded-full"
                ...
                {isMenuOpen && (
                  <div className="absolute bottom-full mb-2 right-0 bg-[#0a0a0a] rounded-lg shadow-xl border border-white/10 p-2 min-w-[140px]">
                    <label className="flex items-center gap-2 p-2 hover:bg-white/10 rounded cursor-pointer text-sm">
                      <ImgIcon size={16} />
                      <span>Images</span>
                      <input
                        type="file"
              ...
              <button
                ...
                className="p-3 text-gray-400 hover:text-purple-400 disabled:opacity-50 disabled:cursor-not-allowed transition-colors rounded-r-full mr-1"
                aria-label="Send message"
              >
                {isLoading || imgLoading ? (
                  <div className="w-5 h-5 border-2 border-gray-400 border-t-purple-400 rounded-full animate-spin"></div>
                ) : (
                  <Send size={20} />
                )}
              </button>
